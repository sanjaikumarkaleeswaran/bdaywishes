...
function playMusic() {
  ...
  // Try to play, but catch the error if autoplay is blocked
  ...
  if (playPromise !== undefined) {
    playPromise
      ...
      .catch(error => {
        // Autoplay was prevented - music will play on first user interaction
        console.log('Autoplay prevented. Music will play on first click.');
      });
  }
}

// Try to play on page load (might be blocked)
...
new TypeIt("#teks1", {
  strings: ["Today, I send my best wishes and prayers just for you", "May the challenges you’ve faced become reasons for you to grow stronger", "May the world always be kind to you wherever you are", "May your days be filled with positivity and support", "May every step you take lead you closer to what you hope to achieve."],
  startDelay: 3000,
  speed: 75,
